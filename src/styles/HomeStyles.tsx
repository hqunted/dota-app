export const HomeStyles = {
  homeScreen: {
    homeContainer: "flex-initial container mx-auto bg-blue-200  ",
    homeTextContainer:
      "text-5xl font-mono font-thin italic text-center leading-loose ",
    homeHeroListContainer: "flex-initial",
  },
  heroListScreen: {
    heroListContainer: "bg-gray-200",
    listboxButton:
    ...
    listboxOptionActiveTrue: "bg-amber-100 text-amber-900",
